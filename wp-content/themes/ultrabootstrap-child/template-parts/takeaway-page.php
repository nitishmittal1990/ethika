...
<section class="agenda takeaway">
	<div class="container">
		<h1>TAKE AWAYS</h1>
		<p>
			Walk away with highly functional and doable strategies <br/>
            and tools to implement Happiness at your workplace. <br/>
            Know the Why’s, What’s and How’s of Workplace <br/>
            Happiness with Experts.
		</p>
	</div>
</section>
<section class="agenda-workshop">
	<div class="container">
		<p class="font-18">The Workshop will equip you with all the learnings and tools you need to become a Happiness Consultant yourself. Build a culture of Happiness at your Workplace or consult other organisations to create Happy Workplaces.</p>
		<ul class="list-unstyled font-16 takeaway-list" id="takeawayE">
			<li>
				Discover the power of a happy workplace
				<p>
			...
			<li>
				Learn the Science behind Workplace Happiness
				<p>
			...
			<li>
				Explore the Happiness Framework
				<p>
			...
			<li>
				Become part of Happiness Community
				<p>
			...
			<li>
				Become a Happiness Consultant to other Organisations
				<p>
